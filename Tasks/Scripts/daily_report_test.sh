...
LOGFILE=$DIR
LOGFILE+="daily_tasks_test.log"
REPORT=$DIR
REPORT+=$DATE
REPORT+="_Daily_Tasks_Report_test.html"
DWARN="/opt/DokuWiki/Tasks/MailHeader/Dwarn_test"
DREPORT="/opt/DokuWiki/Tasks/MailHeader/Dreport_test"
